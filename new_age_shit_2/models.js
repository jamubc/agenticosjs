/**
 * AI model management for the AI Assistant application
 */
...
const Models = {
    ...
    init: function() {
      ...
      document.getElementById('add-integration-btn').addEventListener('click', this.addIntegration.bind(this));
      document.getElementById('integration-type').addEventListener('change', this.handleProviderTypeChange.bind(this));
    },
    ...
    getCurrentContextSize: function() {
      if (!this.currentModel) return Config.contextSizes.default;
    ...
    getApiKey: function() {
      ...
      // For many providers, the key is in api_key
      return this.currentProvider.api_key || null;
    },
